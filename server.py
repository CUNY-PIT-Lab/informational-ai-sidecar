...
PARTICIPANT_COPY = {
    "en": {
        "privacy_message": "Please remove personally identifiable information (PII), such as your six-digit Fortune ID, name, contact, case, or health details. Use the staff link for personal help.",
        "privacy_reason": "Personal details should go only through an approved staff channel.",
        "sensitive_message": "This needs a person, not the guide. Use the staff link below, and leave out case, health, or other personal details here.",
        "sensitive_reason": "A staff member can help with the next step.",
        "missing_message": "I could not find this on an approved Digital Equity page. Use the staff link below, and they can help with the next step.",
        "missing_reason": "The guide will not guess when the approved pages do not answer.",
        "model_missing_message": "The live guide is not available right now. You can still use the page links or ask Digital Equity staff.",
        "model_missing_reason": "The verified directory remains available.",
        "usage_message": "The live guide has reached its shared limit. You can still use the page links or ask Digital Equity staff.",
        "usage_reason": "The limit protects shared access.",
        "model_error_message": "The live guide could not finish that answer. Use the page links or ask Digital Equity staff.",
        "model_error_reason": "The verified directory remains available.",
    },
    "es": {
        "privacy_message": "Por favor, elimina datos personales, como tu identificación de Fortune, nombre, contacto, caso o información de salud. Usa el enlace del personal para recibir ayuda.",
        "privacy_reason": "Comparte datos personales solo por un canal aprobado del personal.",
        "sensitive_message": "Esto necesita la ayuda de una persona. Usa el enlace del personal y no compartas aquí datos de tu caso o salud.",
        "sensitive_reason": "Una persona del equipo puede ayudarte con el próximo paso.",
        "missing_message": "No encontré esto en una página aprobada de Digital Equity. Usa el enlace del personal para recibir ayuda con el próximo paso.",
        "missing_reason": "La guía no inventa respuestas cuando falta información.",
        "model_missing_message": "La guía en vivo no está disponible ahora. Todavía puedes usar los enlaces o pedir ayuda al personal.",
        "model_missing_reason": "El directorio verificado sigue disponible.",
        "usage_message": "La guía en vivo alcanzó su límite compartido. Todavía puedes usar los enlaces o pedir ayuda al personal.",
        "usage_reason": "El límite protege el acceso compartido.",
        "model_error_message": "La guía en vivo no pudo terminar la respuesta. Usa los enlaces o pide ayuda al personal.",
        "model_error_reason": "El directorio verificado sigue disponible.",
    },
}
